package com.roc.admin.backend.webservice.interceptor;
 ...
 * @Date: 2024/5/18
 */
public class WsLogInterceptor extends AbstractPhaseInterceptor<SoapMessage> {
    public WsLogInterceptor(String phase) {
        super(phase);
    }
    ...
    public void handleMessage(SoapMessage message) throws Fault {
        try {
            ...
            if (StringUtils.isNotBlank(input)){
                ...
                input = input.replace("DemoServiceImpl emrService","WsLogInterceptor");
            }
            // 重新写入
