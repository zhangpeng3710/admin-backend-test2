...
(
    ...
    is_available tinyint unsigned default 1 not null comment '是否可用，默认可用',
...
(
    ...
    tenant_id   smallint unsigned not null comment '所属租户id',
    other_desc  varchar(30)           null comment '备注说明',
    create_time datetime          not null comment '创建时间',
    update_time datetime          not null comment '更新时间',
...
(
    id           int unsigned auto_increment primary key,
    role_id      tinyint unsigned           not null comment '角色名称',
...
(
    ...
    el_level     tinyint unsigned default 1 not null comment '层级',
...
(
    ...
    tenant_id    smallint unsigned           not null comment '所属租户id',
    parent_id    smallint unsigned default 0 not null comment '父版本',
    is_available tinyint  unsigned default 1 not null comment '是否可用，默认可用',
    other_desc   varchar(30)                     null comment '备注说明',
    create_time  datetime                    not null comment '创建时间',
    update_time  datetime                    not null comment '更新时间',
...
(
    id           int unsigned auto_increment primary key,
    tomcat_id    smallint unsigned           not null comment 'tomcat版本id',
    bl_id        smallint unsigned           not null comment '基线版本id',
    is_available tinyint  unsigned default 1 not null comment '是否可用，默认可用',
    other_desc   varchar(30)                     null comment '备注说明',
    create_time  datetime                    not null comment '创建时间',
    update_time  datetime                    not null comment '更新时间',
...
(
    id             smallint unsigned auto_increment primary key,
    bl_id          smallint unsigned not null comment '基线id',
...
(
    ...
    agent_id       smallint unsigned           not null comment 'agent版本id',
    parent_id      smallint unsigned default 0 not null comment '父版本',
    is_available   tinyint  unsigned default 1 not null comment '是否可用，默认可用',
    config_details text                        not null comment '配置详情，待确认拆分',
    other_desc     varchar(30)                     null comment '备注说明',
...
(
    id           int unsigned auto_increment primary key,
    agent_id     smallint unsigned           not null comment 'agent版本id',
    config_id    smallint unsigned           not null comment 'agent配置版本id',
    is_available tinyint  unsigned default 1 not null comment '是否可用，默认可用',
    other_desc   varchar(30)                     null comment '备注说明',
    create_time  datetime                    not null comment '创建时间',
    update_time  datetime                    not null comment '更新时间',
...
(
    ...
    inst_status   tinyint  unsigned default 0 not null comment '实例状态',
    config_status tinyint  unsigned default 0 not null comment '实例配置状态',
    tenant_id     smallint unsigned           not null comment '所属租户id',
    app_id        int unsigned                not null comment '所属应用名称',
    cluster_id    int unsigned                    null comment '所属集群id',
    tomcat_id     smallint unsigned               null comment '所属tomcat版本id',
    bl_id         smallint unsigned               null comment '所属基线版本id',
    is_available  tinyint  unsigned default 1 not null comment '是否可用，默认可用',
    other_desc    varchar(30)                     null comment '备注说明',
    create_time   datetime                    not null comment '创建时间',
    update_time   datetime                    not null comment '更新时间',
...
(
    ...
    app_name     varchar(30)     not null comment '应用名称',
    tenant_name  varchar(30)     not null comment '租户名称',
    instance_num bigint unsigned not null comment '实例数量',
    other_desc   varchar(30)         null comment '备注说明',
    create_time  datetime        not null comment '创建时间',
    update_time  datetime        not null comment '更新时间',
...
(
    ...
    agent_status     tinyint unsigned default 0  not null comment '代理状态',
    agent_version_id smallint unsigned           not null comment '代理版本id',
    agent_config_id  smallint unsigned           not null comment '代理版本id',
...
(
    ...
    batch_num     tinyint unsigned default 1 not null comment '当前任务批次',
    batch_total   tinyint unsigned default 1 not null comment '任务批次总数',
    tomcat_id     smallint unsigned              null comment '目标tomcat版本id',
    bl_id         smallint unsigned              null comment '目标基线版本id',
    agent_id      smallint unsigned              null comment '目标代理版本id',
    task_status   tinyint unsigned default 0 not null comment '任务状态',
    task_progress tinyint unsigned default 0 not null comment '任务状态',
...
(
    ...
    upgrade_status tinyint unsigned default 0 not null comment '实例升级状态',
    task_id        int unsigned               not null comment '任务名称',
    batch_num      tinyint unsigned default 1 not null comment '任务批次',
    other_desc     varchar(30)                    null comment '备注说明',
    create_time    datetime                   not null comment '创建时间',
    update_time    datetime                   not null comment '更新时间',
...
(
    ...
    is_online   tinyint unsigned default 1 not null comment '是否在线，登陆默认在线',
    other_desc  varchar(30)                    null comment '备注说明',
    create_time datetime                   not null comment '创建时间',
    update_time datetime                   not null comment '更新时间',
...
(
    ...
    is_available    tinyint unsigned default 1  not null comment '是否可用',
    other_desc      varchar(30)                     null comment '备注说明',
    create_time     datetime                    not null comment '创建时间',
    update_time     datetime                    not null comment '更新时间'
) ;
